...
function CellCompanyContent({place,city}) {
  ...
  return (
    <div className="p-5 pt-0">
        ...
        <p className='text-[16px] mb-5'>Our team is dedicated to providing the top-notch service you deserve, and we want to help you find the right phone and phone plan for your needs. If you are in the  {place},{city}  area and looking for a <span className="font-bold">cell phone company</span>  you can trust to take care of you, we encourage you to <span className='text-orange-600 hover:underline cursor-pointer' onClick={() => navigate("/contact-boost-mobile")}>give us a call.</span></p>
