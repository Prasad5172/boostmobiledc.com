          ...
          <div style={{
            ...
            <div className="flex justify-center items-center z-99 relative" style={{
              ...
              <div className="container  sm:p-20 md:p-20 lg:p-40 xl:p-40  2xl:p-40">
                <h1 className="font-bold text-[25px] md:text-[50px] lg:text-[50px] xl:text-[50px] 2xl:text-[50px] text-white p-0 sm:p-0 md:p-0  lg:p-12 xl:p-12 2xl:p-12 text-center">Cell Phone Company, <span className="font-bold">{place}-{city}</span></h1>
              </div>
            </div>
