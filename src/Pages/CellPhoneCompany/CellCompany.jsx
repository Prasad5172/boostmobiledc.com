  ...
  return (
    <>
        <div>
          ...
          <div style={{
            backgroundImage:"url(./CellPhoneCompany/iStock-1183967715_cover.webp)",
            ...
            <div className="flex justify-center items-center z-99 relative" style={{
              ...
              <div className="container  sm:p-20 md:p-40 lg:p-40 xl:p-40  2xl:p-40">
                <h1 className="font-bold text-[25px] md:text-[50px] lg:text-[50px] xl:text-[50px] 2xl:text-[50px] text-white p-0 sm:p-0 md:p-0  lg:p-12 xl:p-12 2xl:p-12 text-center">Cell Phone Company, {place}, {<span className="font-bold">{place}, {city == "WV" ? "West Virginia": city == "MD" ? "Maryland" : "Pennsylvania"}</span>}</h1>
              </div>
            </div>
            
          </div>
          <BreadCrumb data={[`Cell Phone Company, ${place}, ${city}`]} length={1} />
