  ...
  return (
    <>
      <div>
        ...
        <div style={{
          backgroundImage:"url(./Plans/iStock-1210829077cover.webp)",
          ...
          <div className="flex justify-center items-center z-99 relative" style={{
            ...
            <div className="container  sm:p-20 md:p-40 lg:p-40 xl:p-40  2xl:p-40">
              <h1 className="font-bold text-[25px] md:text-[50px] lg:text-[50px] xl:text-[50px] 2xl:text-[50px] text-white p-0 sm:p-0 md:p-0  lg:p-12 xl:p-12 2xl:p-12 text-center">Phone Plans, <span className="font-bold">{place}-{city}</span></h1>
            </div>
          </div>
          
        </div>
        <BreadCrumb data={[`Phone Plans,${place}, ${city}`]} length={1} />
          ...
          <div className="flex lg:flex-row xl:flex-row 2xl:flex-row flex-col ">
            <div className="lg:basis-2/3 xl:basis-2/3 2xl:basis-2/3">
              <div className="container lg:pl-20 md:pl-15">
                <PlansContent place={place} city={city}/>
              </div>
            </div>
