...
function PayAsYouGo({place,city}) {
    ...
    return (
      <>
          <div>
            ...
            <div style={{
              backgroundImage:"url(./PayAsYouGo/iStock-1148623960_cover1.webp)",
            ...
            <BreadCrumb data={[`Pay-as-You-Go Phone, ${place}, ${city}`]} length={1} />
              ...
              <div className="flex lg:flex-row xl:flex-row 2xl:flex-row flex-col ">
                <div className="lg:basis-2/3 xl:basis-2/3 2xl:basis-2/3">
                  <div className="container lg:pl-20 md:pl-15">
                    <PayAsYouGoContent place={place} city={city} />
                  </div>
                </div>
