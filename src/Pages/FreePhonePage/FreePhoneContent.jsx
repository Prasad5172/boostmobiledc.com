...
function FreePhoneContent({place,city}) {
  ...
  return (
    <div className="p-5 pt-0">
        ...
        <img src="./BillsPage/iStock-1316196030-res.webp" alt="bills image" className='w-full mb-5' />
