    ...
    <>
      <div className="dark:bg-[#111920] relative">
        ...
        <Routes>
          ...
          <Route
            exact
            path="/cell-phone-company-district-heights-md"
            element={<CellCompany place={"District Heights "} city={"MD"} />}
          />
          <Route
            exact
            path="/pay-as-you-go-phone-district-heights-md"
            element={<PayAsYouGo place={"District Heights "} city={"MD"} />}
          />

          <Route
            exact
            path="/boost-mobile-phone-plans-district-heights-md"
            element={<MobilePlans place={"District Heights "} city={"MD"} />}
          />

          <Route
            exact
            path="/free-phone-district-heights-md"
            element={<FreePhone place={"District Heights "} city={"MD"} />}
          />

          <Route
            exact
            path="/pay-your-phone-bill-district-heights-md"
            element={<PhoneBill place={"District Heights "} city={"MD"} />}
          />

          <Route
            exact
            path="/phone-plans-district-heights-md"
            element={<Plans place={"District Heights "} city={"MD"} />}
          />
        ...
        <div
          id="hours"
          className={`flex justify-center items-center  bg-[#000000b5] fixed top-0 bottom-0 left-0 right-0 z-50 ${
            isHourOpen ? "" : "hidden"
          }`}
        >
          <div>
            <div className="bg-white p-4">
              <div className="flex justify-end relative">
                <div
                  className="inline-block px-2 hover:bg-gray-500 rounded-full border-2 border-orange-600  bg-black cursor-pointer absolute top-minus-25 right-minus-25"
                  onClick={handleHours}
                >
              ...
              <div className="bg-orange-500  flex justify-center p-3">
                <a
                  href="tel: 3012785974"
                  className=" text-white items-center  text-center font-bold cursor-pointer"
                >
                  <FontAwesomeIcon
                    icon={faPhone}
                    style={{ fontSize: "15px" }}
              ...
              <p
                ...
                className="bg-orange-500 mt-4 text-white p-3 text-center font-bold cursor-pointer"
              >
                Contact Us
              </p>
            </div>
      ...
      <div className="call_header lg:hidden bg-orange-500 flex justify-center sticky bottom-0 z-10 border-t-2 border-white border-solid">
        <table className="">
          <tbody>
            <tr>
              <td
                className="text-center p-1 text-shadow text-base cursor-pointer flex items-center"
                onClick={handleHours}
              >
                <img
                  src="./ck_mobile.webp"
